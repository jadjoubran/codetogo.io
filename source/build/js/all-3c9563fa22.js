...
var subscribeCta = document.querySelector('.subscribe-cta');
if (subscribeCta) {
...
var subscribeClose = document.querySelector('#subscribe-close');
if (subscribeClose) {
...
/* http://prismjs.com/download.html?themes=prism-dark&languages=clike+javascript */
